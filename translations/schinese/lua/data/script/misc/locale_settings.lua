...
all_languages = 
{
	...
	, { id = "zh_cn", nativeName = "简体中文", englishName = "Chinese", audioName = "english_us_/" } -- Or choose any audioName above
}
...
function initLanguagesPerPlatformOrBuild()
	...
	if platformModule:isPlatformWindows() or platformModule:isPlatformOSX() or platformModule:isPlatformLinux() then
		if FB_BUILD == "FB_FINAL_RELEASE" then
			...
			tmplanguages =					{"en", "de", "fr", "es", "it", "zh_cn"}
			tmpguiLocaleLanguages =			{"en", "de", "fr", "es", "it", "zh_cn"}
			tmpsubtitleLocaleLanguages =	{"en", "de", "fr", "es", "it", "zh_cn"}
