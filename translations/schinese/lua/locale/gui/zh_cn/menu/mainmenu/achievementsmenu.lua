...
descsurf = "站在悬浮在单气流之上的木板上4秒钟"
deschazard = "在一个关卡中让妖精死于三种不同的环境"
descsolo = "只用一个角色完成一个关卡"
desccarni = "用三种不同的方法给肉食性植物喂食"
descshatter = "同时击碎三个已经结冰的敌人"
deschammer = "在杀死一个敌人之前至少使用爆裂锤击一次"
descfriendly_fire = "在一个关卡中利用一个敌人杀死至少10个敌人"
descbounce = "站在一个位于任意弹性地面的召唤出的箱子上10秒钟"
descarrow = "向空中射出三支箭， 并用武士的盾牌接住"
desctower = "用八个物体建造一个塔并站在最上面"
descrope = "使用爪勾抓住物体后飘荡， 松开后在不接触地面的情况下再次粘抓到该物体上"
descbubble = "沉到水里3秒钟"
